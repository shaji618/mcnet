    ...
    <div className='announcements-container'>
      <div className='announcements-flex-container'>
        <div
          ...
          onClick={() => setAnnouncementState('first')}
        >
          <div
            className={`icon announcement-header ${
              announcementState === 'first' ? 'active' : ''
            }`}
          >
            <div className='icon'>
        ...
        <div
          className='announcement-card'
          onClick={() => setAnnouncementState('second')}
        >
          <div
            className={`announcement-header ${
              announcementState === 'second' ? 'active' : ''
            }`}
          >
            <div className='icon'>
        ...
        <div
          className='announcement-card'
          onClick={() => setAnnouncementState('third')}
        >
          <div
            className={`icon announcement-header ${
              announcementState === 'third' ? 'active' : ''
            }`}
          >
            <div className='icon'>
      ...
      {announcementState === 'first' && (
        <div className='announcement-content'>
          <h3>Eid 2023</h3>
          <p>EID MUBARAK to all of you!</p>
          <p>
            AlhamduliLlaah! The new moon of Shawwaal has been sighted at several
            places in North America. Insha'Allaah EID-UL-FITR will be on Friday,
            April 21, 2023.
          </p>
          <p>
          ...
          <ul>
            <li>
              Eid Salat will be at 8:30 AM on Friday, April 21, 2023. Eid Salat
              will be outside the Masjid in the Soccer field. Please bring
              "Prayer Rug" with you and dress comfortably while keeping in mind
              tomorrow's weather.
            </li>
            <li>
              Please bring two breakfast dishes to share for "Potluck Breakfast"
              after Eid Salat.
            </li>
